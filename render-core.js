...
// render() dispatcher + Sessions and Entry screens and their partial refreshes,
// plus the top-level modals render() emits (migration prompt, welcome, first-run
// wizard, signature pad, reopen warning). Owns: const app = #app.
//
// v72: Overview, Edit Session, Retest Reminders, the Reports hub and the shared
// photo-evidence markup moved OUT to render-review.js — byte identical, render()
// untouched. render() still calls all of them; they resolve at call time.
// renderEntry() calls renderFailPhotoStripInner() / renderPhotoStripSheet()
// which now live there too.
